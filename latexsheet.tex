...
\begin{tabular}{@{}ll@{}}
	...
	\verb!! & \hspace{-75} Even function, strictly positive, dies monotonically...\\
	\verb!Multivariate Normal! & Note that x and m are vectors \\
	\verb!! & \hspace{-55}$f(x)=\frac{1}{2\pi^{\frac{n}{2}} det(A)^{\frac{1}{2}}}exp(-\frac{1}{2}(x-m)A^{-1}(x-m)^T)$
